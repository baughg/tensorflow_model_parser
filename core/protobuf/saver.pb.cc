...
namespace protobuf_saver_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "saver.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "saver.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::EnumDescriptor* SaverDef_CheckpointFormatVersion_descriptor() {
  protobuf_saver_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_saver_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::Descriptor* SaverDef::descriptor() {
  ::protobuf_saver_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_saver_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata SaverDef::GetMetadata() const {
  protobuf_saver_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_saver_2eproto::file_level_metadata[kIndexInFileMessages];
}
