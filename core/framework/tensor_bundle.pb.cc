...
void InitDefaultsBundleEntryProtoImpl() {
  ...
  protobuf_tensor_5fslice_2eproto::InitDefaultsTensorSliceProto();
  {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensor_bundle.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "tensor_bundle.proto", &protobuf_RegisterTypes);
  ::protobuf_tensor_5fshape_2eproto::AddDescriptors();
  ::protobuf_tensor_5fslice_2eproto::AddDescriptors();
...
const ::google::protobuf::EnumDescriptor* BundleHeaderProto_Endianness_descriptor() {
  protobuf_tensor_5fbundle_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensor_5fbundle_2eproto::file_level_enum_descriptors[0];
}
...
BundleHeaderProto::BundleHeaderProto()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensor_5fbundle_2eproto::InitDefaultsBundleHeaderProto();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* BundleHeaderProto::descriptor() {
  ::protobuf_tensor_5fbundle_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensor_5fbundle_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata BundleHeaderProto::GetMetadata() const {
  protobuf_tensor_5fbundle_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensor_5fbundle_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
BundleEntryProto::BundleEntryProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensor_5fbundle_2eproto::InitDefaultsBundleEntryProto();
  }
  SharedCtor();
